...
9.    [Custom Startup Script for Debian](#Custom Startup Script for Debian)
...
# <a name= "Custom Startup Script for Debian"></a> Custom Startup Script for Debian
...
Install 'virtuoso-opensource' as per normal. Then compile, install and configure virtuoso as [[described here|VirtuosoBackend]], making sure to use '/usr/local' for configuration prefix.

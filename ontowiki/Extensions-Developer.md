...
We recommend to re-configure some php runtime variables for OntoWiki. Please have a look at [Deployment-Recommendations]({{ "Deployment-Recommendations.html" | prepend:site.baseurl }}).-->

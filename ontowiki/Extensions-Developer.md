...
We recommend to re-configure some php runtime variables for OntoWiki. Please have a look at [Deployment-Recommendations](http://docs.ontowiki.net/ontowiki_Deployment-Recommendations).-->
...
We got a centralized Repository for extensions. Every OntoWiki can browse the available extensions and provides a install mechanism: in the [Extension-Configurator](http://docs.ontowiki.net/ontowiki_Extensions/#extension-api-and-development) or directly at http://your-ontowiki/exconf/explorerepo
...
Develop the source files ([HowTo](http://docs.ontowiki.net/ontowiki_Extensions)), test your extensions locally, package into a zip archive, put it on a accessable webserver. We recommend GitHub (you will have the autogenerated zip of the current state there).

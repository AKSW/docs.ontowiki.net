...
permalink: /Custom-startup-script-for-Debian.html
...
Install 'virtuoso-openspurce' as per normal. Then compile, install and configure virtuoso as [described here]({{ "VirtuosoBackend.html" | prepend:site.baseurl }}), making sure to use '/usr/local' for configuration prefix.

...
permalink: /How-to-publish-my-product-information-as-Linked-Data.html
...
For directions on how get this data into the knowledge base, see [How to create and publish a SKOS Taxonomy in 5 minutes - Add classes and properties using dialogs]({{ "How-to-cerate-and-publish-a-SKOS-taxonomy-in-5-minutes.html#a-iddialogaadd-classes-and-properties-using-dialogs" | prepend:site.baseurl }}).
